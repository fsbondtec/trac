...
t.changetime AS changetime,priority.value AS priority_value,\
...
priority.value AS priority_value,%(type)s.value AS %(type)s
FROM ticket AS t
...
t.time AS time,t.changetime AS changetime,\
priority.value AS priority_value,%(milestone)s.value AS %(milestone)s
FROM ticket AS t
